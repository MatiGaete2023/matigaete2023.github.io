...
const files = ['blueprint.js','banco-comun.js','banco-civil.js','banco-penal.js','banco-familia.js','banco-laboral.js'];
...
globalThis.__bank=[...PF93_DRAFT_COMMON,...PF93_DRAFT_CIVIL,...PF93_DRAFT_PENAL,...PF93_DRAFT_FAMILIA,...PF93_DRAFT_LABORAL];`, context);
...
const result={version:context.PF93_BLUEPRINT_VERSION,topics:bp.length,total:bank.length,byCode:codeActual,byTrack:trackTotals,answerDistribution:{A:answerDist[0],B:answerDist[1],C:answerDist[2],D:answerDist[3]},warnings:warnings.slice(0,50),warningCount:warnings.length,errorCount:errors.length,errors};
